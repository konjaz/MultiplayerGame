...
public class BattleSystem : MonoBehaviour {
    ...
    public BulletScript GetBullet()
    {
        ...
        return MyClient.GetInactiveBullet();//(PhotonNetwork.Instantiate(BulletSpawner.staticBulletPrefab.name, Vector3.zero, Quaternion.identity, 0) as GameObject).GetComponent<BulletScript>();
    }
